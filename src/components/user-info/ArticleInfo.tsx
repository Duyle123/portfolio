const ArticleInfo = [{
    ...
    thumbnail: '',
    thumbnailAlt:'Tera Group Co. Ltd. Technology Company with 3d made logo, Slogan says Tera Cells Make The Universe. Made by Duy Le and Dong Luong',
    primaryColor: '#8210A5',
...
},
{
    ...
    summary: 'Media Website informing ',
    thumbnail: '',
